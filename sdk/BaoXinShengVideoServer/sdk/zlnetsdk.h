...
typedef struct
{
	...
	char deviceIp[ZLNET_AEB_IP_LEN];		//美电贝尔GB28181 Device IP
	int nDevicePort;						//美电贝尔GB28181 Device  端口
...
typedef struct _ZLNET_IVA_BZS_TRACK
{
	DWORD nTrackID;
	WORD  nPosX;
	WORD  nPosY;	//当nPosX和nPosY都为0的时候代表一个物体轨迹跟踪结束
}ZLNET_IVA_BZS_TRACK; 
...
{
	DWORD  nTrackNum;
	ZLNET_IVA_BZS_TRACK stTrackInfo[MAX_TRACK_COUNT];
