...
class DLLEXPORT_API QFtp : public QObject
{
    Q_OBJECT
...
Q_SIGNALS:
	...
	void listInfo(const myQUrlInfo&);
    void readyRead();
...
public:
	...
	static bool parseDir(const QByteArray &buffer, const QString &userName, myQUrlInfo *info);
