...
void MainWindow::setMenuByUser(){
    ui->videoDownloadBtn->setEnabled(User::current().isCollect());
    ui->screenBtn->setEnabled(User::current().isCollect());

    ui->diskBtn->setEnabled(User::current().isExport());
    ui->shareBtn->setEnabled(User::current().isExport());

    ui->userManagerBtn->setEnabled(User::current().isAdmin());
    ui->logBtn->setEnabled(User::current().isAdmin());
}
...
void MainWindow::onuserManagerBtnclicked()
{
