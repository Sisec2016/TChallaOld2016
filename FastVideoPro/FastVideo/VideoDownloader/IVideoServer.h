...
enum DeviceFactory
{
    ...
    ETIM_IPC_ZHENSHISHUN = 1001,                      // 臻视顺
    ETIM_IPC_JINSHANPINKE,                            // 金山品科
    ETIM_IPC_XUFENGWS,                                // 旭峰威视
    ETIM_IPC_XINGSHIBAO,                              // 欣视宝
    ...
    ETIM_IPC_BJYKJY,                      // 北京英康嘉业
    ETIM_IPC_GZSTH,                            // 广州市泰豪
    ETIM_IPC_SZSAY,                                // 深圳市安裕
    ETIM_IPC_GZZT,                              // 广州左田
