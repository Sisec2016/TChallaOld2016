...
public:
    ...
    void ScanIp(vector<QString> &vecIp, bool bArp = false, std::shared_ptr<bool> bpCancel = std::shared_ptr<bool>());
    void ScanIPs(vector<QString> &vecIP, const QString& netIp, bool bArp = false, std::shared_ptr<bool> bpCancel = std::shared_ptr<bool>());
    bool ScanOneIP(QString &ip, const QString& netIp, bool bArp = false);
