...
void CPing::ScanIp(vector<QString> &vecIp, bool bArp, std::shared_ptr<bool> bpCancel)
{
...
void CPing::ScanIPs(vector<QString> &vecIPs, const QString& netIp, bool bArp, std::shared_ptr<bool> bpCancel){
