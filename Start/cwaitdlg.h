...
public:
    template<class Fn>
    static void waitForDoing(QWidget *parent, QString s, Fn F, std::function<void (bool)> OFF, bool bHideCancel=true)
    {
		CWaitDlg* pDlg = CWaitDlg::create(parent, bHideCancel);
		pDlg->mbHideCancel = bHideCancel;
        sCwaitdlg = pDlg;
        spDlg.insert(pDlg);
